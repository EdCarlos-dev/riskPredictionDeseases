...
now = datetime.now()
experiment_name_path = 'experiment_14_08_2025' #f'experiment_{now.strftime("%d_%m_%Y")}'
...
xpt_output_dir = f'{notebook_dir_project_predict}data{os.sep}input{os.sep}2023{os.sep}{experiment_name_path}'
csv_output_dir = f'{notebook_dir_project_predict}data{os.sep}intermediate{os.sep}2023{os.sep}{experiment_name_path}'
...
arquivo_xpt = f"{notebook_dir_project_predict}data{os.sep}input{os.sep}2023{os.sep}{experiment_name_path}{os.sep}LLCP2023.XPT"
...
# %%
df_2023_csv = pd.read_csv(f'{notebook_dir_project_predict}data{os.sep}intermediate{os.sep}2023{os.sep}{experiment_name_path}{os.sep}brfss_2023.csv')

# salve num txt a saida do .info()
with open(f'{notebook_dir_project_predict}data{os.sep}intermediate{os.sep}2023{os.sep}{experiment_name_path}{os.sep}brfss_2023_info.txt', 'w') as f:
...
html_output_dir = f'{notebook_dir_project_predict}data{os.sep}input{os.sep}2023{os.sep}{experiment_name_path}'
csv_output_dir_codebook = f'{notebook_dir_project_predict}data{os.sep}intermediate{os.sep}2023{os.sep}{experiment_name_path}'
...
df_vars_2023.to_csv(f"{notebook_dir_project_predict}data{os.sep}intermediate{os.sep}2023{os.sep}{experiment_name_path}{os.sep}brfss_2023_variaveis.csv", index=False)
...
with open(f"{notebook_dir_project_predict}data{os.sep}input{os.sep}2023{os.sep}USCODE23_LLCP_021924.HTML", "r", encoding="utf-8") as f:
    html_content = f.read()
...
df_vars_2023_translated = pd.read_csv(f"{notebook_dir_project_predict}data{os.sep}intermediate{os.sep}2023{os.sep}{experiment_name_path}{os.sep}brfss_2023_variaveis.csv")
...
df_vars_2023_translated.to_csv(f"{notebook_dir_project_predict}data{os.sep}intermediate{os.sep}2023{os.sep}{experiment_name_path}{os.sep}brfss_2023_variaveis_translated.csv", index=False)
...
html_path = f"{notebook_dir_project_predict}data{os.sep}input{os.sep}2023{os.sep}{experiment_name_path}{os.sep}USCODE23_LLCP_021924.HTML"
...
json_vars_path_file = f"{notebook_dir_project_predict}data{os.sep}intermediate{os.sep}2023{os.sep}{experiment_name_path}{os.sep}brfss_2023_variaveis.json"
...
df_resultado.to_csv(f"{notebook_dir_project_predict}data{os.sep}intermediate{os.sep}2023{os.sep}{experiment_name_path}{os.sep}brfss_2023_variaveis_expandidas.csv", index=False)
...
# Copiar o dataframe df_vars_2023
df_vars_2023_expand_translated = pd.read_csv(f"{notebook_dir_project_predict}data{os.sep}intermediate{os.sep}2023{os.sep}{experiment_name_path}{os.sep}brfss_2023_variaveis_expandidas.csv")
...
new_df.to_csv(f"{notebook_dir_project_predict}data{os.sep}intermediate{os.sep}2023{os.sep}{experiment_name_path}{os.sep}brfss_2023_variaveis_expandidas_translated.csv", index=False)
new_df

# %%
df_vars_2023_expand_translated_read = pd.read_csv(f"{notebook_dir_project_predict}data{os.sep}intermediate{os.sep}2023{os.sep}{experiment_name_path}{os.sep}brfss_2023_variaveis_expandidas_translated.csv")
